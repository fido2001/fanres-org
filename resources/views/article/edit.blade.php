                            ...
                            <div class="row p-t-20">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{ $video->thumbnail }}" name="thumbnail" class="form-control @error('thumbnail') is-invalid @enderror" required>
                                        @error('thumbnail')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{ $video->link_file }}" name="link_file" class="form-control @error('link_file') is-invalid @enderror" required>
                                        @error('link_file')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
